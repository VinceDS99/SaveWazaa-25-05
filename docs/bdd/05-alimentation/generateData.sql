...
VALUES (1,"Roberson","Tiger","CP 129, 2067 Vestibulum Chemin","05 92 16 16 15","ornare1@neque.net","secretaire","DRR97WeL5F*"),
       (2,"Murray","Maryam","3426 Pede Impasse","07 02 13 28 28","quis.lectus.Nullam@Praesenteu.com","directeur","*FSO42lWW3dJ"),
       (3,"Russo","Farrah","CP 229, 1578 Ullamcorper Route","05 40 73 06 58","id.blandit.at@euenim.co.uk","secretaire","NTW50qQP0Nv+"),
       (4,"Flores","Imani","7117 Proin Rue","01 42 34 84 53","vestibulum.Mauris@massalobortisultrices.org","secretaire","YXm22WGU8EJ+"),
       (5,"English","Nolan","9372 Nonummy Route","02 19 23 66 54","porttitor.vulputate.posuere@justoProin.org","secretaire","OCJ05CTq4W+X"),
       (6,"Christian","Hamilton","8095 Vitae Av.","01 51 14 36 53","nec.ante@acsemut.org","secretaire","AXA06v+KO6BD"),
       (7,"Bernard","Kirk","CP 811, 8358 Vestibulum, Route","06 48 27 77 42","est.tempor@egestasFuscealiquet.edu","negociateur immobilier","RTF05XZg%6NV"),
       (8,"Mathis","Angela","Appartement 397-7856 Bibendum Rd.","06 39 05 50 28","nonummy.ac.feugiat@vitaeorciPhasellus.org","negociateur immobilier","TVJ44Lb+L4QV"),
...
INSERT INTO `waz_negocier` (`emp_id`, `in_id`, `an_id`, `neg_est_conclu`, `neg_montant_transaction`,
                            `neg_date_debut_transaction`, `neg_date_transaction_fin`, `neg_date_dernier_contact`)
VALUES
